...
// configuration step. It creates a namespace called `C`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", C::cmake::project_name, C::cmake::project_version) };
